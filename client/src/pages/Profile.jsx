    ...
    return (
        <div className="p-3 max-w-lg mx-auto">
          ...
          <div className="flex justify-between mt-3">
            <span onClick={handleDeleteUser} className="text-yellow-700 cursor-pointer">Delete Account</span>
            ...
            <p className="text-red-700 mt-5">{showListingsError? 'Error Showing Listings':""}</p>
             ...
             {userListings && userListings.length>0 && ( <div className="flex flex-col gap-4">
                <h1 className="text-center  mt-7 text-2xl font-semibold">Your List</h1>
