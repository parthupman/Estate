        ...
        <div className="p-3 max-w-lg mx-auto">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <p className="text-sm self-center"> 
                {fileUploadError ? (<span className="text-red-700">Error uploading image(Must be less than 2mb)</span>) : filePerc >0 && filePerc < 100 ?(
          ...
          <div className="flex justify-between mt-3">
            <span className="text-yellow-700 cursor-pointer">delete account</span>
            <span className="text-yellow-700 cursor-pointer">sign out</span>
            
          </div>
            {error && <p className="text-red-700 mt-3">{error}</p>}
            {updateSuccess && <p className="text-green-700 mt-3">Profile updated successfully</p>}
        </div>
    )
}
